...
import { listProductSale } from "../../Redux/Actions/ProductActions";
import Loading from "../LoadingError/Loading";
import Message from "../LoadingError/Error";

const ShopSectionSale = (props) => {
  ...
  const productListSale = useSelector((state) => state.productListSale);
  const { loading, error, products, page, pages } = productListSale;

  useEffect(() => {
    dispatch(listProductSale(keyword, pagenumber));
...
export default ShopSectionSale;